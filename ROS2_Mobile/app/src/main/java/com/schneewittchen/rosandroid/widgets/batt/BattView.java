 ...
 */
public class BattView extends SubscriberWidgetView {

    public static final String TAG = BattView.class.getSimpleName();
    ...
    public BattView(Context context) {
        super(context);
        init();
    }

    public BattView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public void setWidgetEntity(BaseEntity widgetEntity) {
        ...
        BattEntity entity = (BattEntity) widgetEntity;
    ...
    public void onNewMessage(MessageDefinition message) {
        ...
        BattData data;
        data = new BattData((Twist) message);

        if (displayVoltage) {
            this.updateVoltage((float) data.x);
        } else {
            this.updatePercentage((float) data.x);
        }
        this.invalidate();
    }
